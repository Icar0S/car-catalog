...
const brandBackgrounds = {
  ...
  function displayVehicles(vehicles, brand, searchTerm = '') {
    ...
    vehicles.forEach(vehicle => {
        ...
        // Verifica se o veículo tem múltiplas imagens
        const hasMultipleImages = Array.isArray(vehicle.images) && vehicle.images.length > 1;
        const imageUrl = hasMultipleImages ? vehicle.images[0] : vehicle.image;
        ...
        card.innerHTML = `
            <div class="image-container">
                <img src="${imageUrl}" alt="${vehicle.model}" 
                     ...
                     ${hasMultipleImages ? 'data-images="' + vehicle.images.join(',') + '"' : ''}>
            </div>
        ...
        if (hasMultipleImages) {
            ...
            card.addEventListener('mouseleave', () => {
                ...
                img.src = vehicle.images[0]; // Volta para a primeira imagem
                currentIndex = 0;
            });
        }
